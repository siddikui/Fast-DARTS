...
#python dot2png.py --src_dir '/home/sidiki/darts/cnn/plots/' --dst_dir '/home/sidiki/darts/cnn/gifs/' --gif_prefix 'try'
#python dot2png.py --src_dir '/home/sidiki/fdarts/cnn/search-EXP-20190806-185426/plots' --dst_dir '/home/sidiki/fdarts/cnn/search-EXP-20190806-185426/gifs' --gif_prefix 'fdarts'
...
def to_gif(dst_dir, gif_prefix):
    ...
    cmd = "convert -resize 40% -delay 30 -loop 0 {target_glob} {output_path}".format(
        ...
        output_path=os.path.join(dst_dir[:-5], gif_prefix+"normal.gif"))
    ...
    cmd = "convert -resize 40% -delay 30 -loop 0 {target_glob} {output_path}".format(
        ...
        output_path=os.path.join(dst_dir[:-5], gif_prefix+"reduce.gif"))
    subprocess.call(cmd, shell=True)
